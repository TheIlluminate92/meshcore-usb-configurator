...
- `updater.py`, `update_ui.py`, release workflow: explicit GitHub release updates with transient authentication, digest validation, retained previous EXE and deferred replacement.
