...
def apply_theme(root):
    ...
    style.configure('Title.TLabel', background=INK, foreground='white', font=('Segoe UI', 24, 'bold'))
    ...
    style.configure('Note.TLabel', foreground=MUTED, padding=(0, 10))
    ...
    style.configure('TNotebook.Tab', padding=(14, 11), background='#dfe8f0', foreground=MUTED, font=('Segoe UI', 10))
